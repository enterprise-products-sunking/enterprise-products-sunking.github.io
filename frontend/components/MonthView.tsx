                        ...
                        >
                            ...
                            <div className="mt-1 space-y-1">
                                {displayShifts.map(shift => {
                                    ...
                                    // we can use proper badge styles here or keep custom. Custom is fine for now to match card logic.
                                    ...
                                    return (
                                        <div
                                            ...
                                            className={cn(
                                                "text-[10px] px-1.5 py-0.5 rounded border truncate hover:brightness-95 transition-all",
                                                fallbackColor
                                            )}
                                        >
